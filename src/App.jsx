...
import {
  ...
  CheckCircle, Instagram, Linkedin, Facebook, Youtube
} from 'lucide-react';
          ...
          <section id="hero">
            <div className="hero-video-bg">
              <video autoPlay loop muted playsInline>
                <source src="video/AKV Global Consultant.mp4" type="video/mp4" />
            ...
            <div className="footer-top">
              ...
              <div className="footer-col">
                ...
                <div className="footer-links">
                  <span className="footer-link" onClick={() => { setListingTab('Buy'); setFilterType(''); navigate('listings'); }}>Buy</span>
                  <span className="footer-link" onClick={() => { setListingTab('Rent'); setFilterType(''); navigate('listings'); }}>Rent</span>
                  <span className="footer-link" onClick={() => { setListingTab('Off-Plan'); setFilterType(''); navigate('listings'); }}>Off-Plan</span>
                  <span className="footer-link" onClick={() => { setListingTab('All'); setFilterType(''); navigate('listings'); }}>Featured Properties</span>
                </div>
              </div>
              <div className="footer-col">
                <h4>Explore</h4>
